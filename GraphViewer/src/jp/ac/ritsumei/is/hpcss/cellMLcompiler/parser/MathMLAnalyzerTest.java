...
public class MathMLAnalyzerTest {
	/**
	...
	*/
	...
	public static void main(String args[]){
		...
		*/
		...
		//---------------------------------------------------
		/*解析器インスタンス生成*/
		MathMLAnalyzer pMathMLAnalyzer = new MathMLAnalyzer();

		/*各ファイル名初期化*/
		String strRelMLFileName;
		String strTecMLFileName;
	//	String strCellMLFileName="sample/fhn.cellml";
		String strCellMLFileName="sample/dxdtdydt_MathMLwithtree.recml";

		/*RelMLの解析*/
		if(!parseXMLFile(strCellMLFileName, parser, pMathMLAnalyzer)){
		System.exit(1);
		}
